...
public class YoklamaProgrami_v4 {
    public static void main(String[] args) {
        JFileChooser fileChooser = new JFileChooser();

        fileChooser.setDialogTitle("Sınıf Listesini Seçiniz");
        ...
        fileChooser.setDialogTitle("Ders Katılım Listesini Seçiniz");
        ...
        int kontrolSecim = JOptionPane.showConfirmDialog(null, "Oluşturulan verileri kontrol etmek ister misiniz?", "Kontrol Et", JOptionPane.YES_NO_OPTION);
        if (kontrolSecim == JOptionPane.YES_OPTION) {
